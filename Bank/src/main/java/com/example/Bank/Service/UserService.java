...
public class UserService implements UserDetailsService {
    ...
    public void setDefaultRole(String PhoneNumber) {
    ...
    @Override
    public UserDetails loadUserByUsername(String PhoneNumber) throws
    ...
    public Optional<User> findByPhoneNumber(String PhoneNumber) throws
            UsernameNotFoundException {
